package com.example.webshop_api_spring;

import com.example.webshop_api_spring.model.Customer;
import com.example.webshop_api_spring.model.CustomerOrder;
import com.example.webshop_api_spring.model.Item;
...
import com.example.webshop_api_spring.repository.ItemRepository;
import com.example.webshop_api_spring.repository.OrderEntryRepository;
...
public class WebshopApiSpringApplication {

    public static void main(String[] args) {
        SpringApplication.run(WebshopApiSpringApplication.class, args);
    }
    ...
    public CommandLineRunner initDb(CustomerRepository customerRepository, CustomerOrderRepository customerOrderRepository, OrderEntryRepository orderEntryRepository, ItemRepository itemRepository) {
        return (args) -> {
            ...
            var newCustomers = List.of(
                    ...
                    new Customer("Lasse", "Lasseman", "9604016444")
            );
